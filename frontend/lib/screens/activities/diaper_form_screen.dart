...
class _DiaperFormScreenState extends State<DiaperFormScreen> {
  ...
  String _diaperType = 'wet'; // wet, dirty, both
  ...
  void _loadActivityData() {
    ...
    // Cargar tipo de pañal
    if (activity.data?['diaper_type'] != null) {
      _diaperType = activity.data!['diaper_type'];
    }
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text(
              _isEditMode ? 'Editar Pañal' : 'Cambio de Pañal',
  ...
  Widget _buildDiaperTypeOption(
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: isSelected ? color.withOpacity(0.1) : const Color(0xFFFAFAFA),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
