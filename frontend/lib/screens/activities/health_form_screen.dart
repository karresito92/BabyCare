...
class _HealthFormScreenState extends State<HealthFormScreen> {
  ...
  void _loadActivityData() {
    ...
    // Cargar motivo
    if (activity.data?['reason'] != null) {
      _reasonController.text = activity.data!['reason'];
    }
    
    // Cargar temperatura
    if (activity.data?['temperature'] != null) {
      _temperatureController.text = activity.data!['temperature'].toString();
    }
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text(
              _isEditMode ? 'Editar Salud' : 'Salud',
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Ej: Vacunación, Revisión, Malestar...',
